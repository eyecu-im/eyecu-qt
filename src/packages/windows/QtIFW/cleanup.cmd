...
for %%f in (adiummessagestyle mapsearch.navitel messagearchiver mmplayer pepmanager.geoloc.positioning.serialport) do del packages\ru.rwsoftware.eyecu.%%f\meta\package.xml /Q
