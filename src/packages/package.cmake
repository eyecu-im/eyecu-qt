if (WIN32)
	...
	#set(CPACK_PACKAGE_EXECUTABLES ${EYECU_LOADER_NAME} "eyeCU-IM")
	set(CPACK_NSIS_CREATE_ICONS_EXTRA "CreateShortCut '\$SMPROGRAMS\\\\$STARTMENU_FOLDER\\\\eyeCU-IM.lnk' '\$INSTDIR\\\\eyecu.exe'")
	#set(CPACK_NSIS_CONTACT "http://www.vacuum-im.org")
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "eyecuIM")
endif (WIN32)
...
set(CPACK_PACKAGE_INSTALL_DIRECTORY "eyeCU-IM")
set(CPACK_RESOURCE_FILE_README "${CMAKE_SOURCE_DIR}/README")
if (NOT APPLE)
	set(CPACK_RESOURCE_FILE_LICENSE "${CMAKE_SOURCE_DIR}/COPYING")
endif (NOT APPLE)
set(CPACK_RESOURCE_FILE_WELCOME "${CMAKE_SOURCE_DIR}/CHANGELOG")
set(CPACK_PACKAGE_FILE_NAME "eyecu-im-${VERSION}-installer")
