...
# Copyright (C) 2010 Kozlov K.S.
# Copyright (C) 2010 Tselykh V.N.
...
strip "$CONTENTS_DIR/MacOS/eyeCU"
process_binary "$CONTENTS_DIR/MacOS/eyeCU" ""
...
cp "$SVN_ROOT/eyeCU.icns" "$ICON_FOLDER/.VolumeIcon.icns"
