...
#define _QT_USAGE_ENVIRONMENT0_HH

#ifndef _QTUSAGEENVIRONMENT_VERSION_HH
#include "QtUsageEnvironment_version.hh"
#endif
...
class QtUsageEnvironment0: public UsageEnvironment {
public:
...
protected:
  QtUsageEnvironment0(TaskScheduler& taskScheduler);
  virtual ~QtUsageEnvironment0();
