...
QtUsageEnvironment0::QtUsageEnvironment0(TaskScheduler& taskScheduler)
  : UsageEnvironment(taskScheduler),
    fBufferMaxSize(RESULT_MSG_BUFFER_MAX) {
  reset();
}

QtUsageEnvironment0::~QtUsageEnvironment0() {
}

void QtUsageEnvironment0::reset() {
  fCurBufferSize = 0;
...
char const* QtUsageEnvironment0::getResultMsg() const {
  return fResultMsgBuffer;
}

void QtUsageEnvironment0::setResultMsg(MsgString msg) {
  reset();
  appendToResultMsg(msg);
}

void QtUsageEnvironment0::setResultMsg(MsgString msg1, MsgString msg2) {
  setResultMsg(msg1);
...
void QtUsageEnvironment0::setResultErrMsg(MsgString msg, int err) {
  setResultMsg(msg);
...
void QtUsageEnvironment0::appendToResultMsg(MsgString msg) {
...
void QtUsageEnvironment0::reportBackgroundError() {
