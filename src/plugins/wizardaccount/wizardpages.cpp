...
NetworkPage::NetworkPage(QWidget *AParent): QWizardPage(AParent)
{
	...
	QLabel *lblNotice = new QLabel(tr("There are some social networks, portals or blogging services, which have their own XMPP servers. "
				...
				"At the same time, they have only limited set of standard XMPP extension implemented. "
				"Usually, only minimum of standard XMPP features implemented and could be used with standard XMPP cliends.\n"
