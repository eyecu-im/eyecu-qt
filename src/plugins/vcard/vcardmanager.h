...
public:
	...
	virtual bool publishVCard(const Jid &AStreamJid, const Jid &AContactJid, IVCard *AVCard);
	virtual QDialog *showVCardDialog(const Jid &AStreamJid, const Jid &AContactJid, bool AMuc=false, QWidget *AParent = NULL);
signals:
