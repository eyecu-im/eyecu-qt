...
public:
	...
	virtual IDataStreamSocket *dataStreamSocket(const QString &AStreamId, const Jid &AStreamJid, const Jid &AContactJid, IDataStream::Kind AKind, QObject *AParent=NULL);
