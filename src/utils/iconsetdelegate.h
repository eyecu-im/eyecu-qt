...
protected:
	...
	QRect checkButtonRect(const QStyleOptionViewItem &AIndexOption, const QRect &ABounding, const QVariant &AValue) const;
	void drawCheckButton(QPainter *APainter, const QStyleOptionViewItem &AIndexOption, const QRect &ARect, Qt::CheckState AState) const;
	QStyleOptionViewItem indexStyleOption(const QStyleOptionViewItem &AOption, const QModelIndex &AIndex) const;
private:
